...
this.Btn_Inventory.addEventListener(MouseEvent.CLICK, change_top_menu_s5);
this.Btn_Mission_Log.addEventListener(MouseEvent.CLICK, change_top_menu_s5);
this.Btn_Settings.addEventListener(MouseEvent.CLICK, change_top_menu_s5);

this.Btn_Left_Top.addEventListener(MouseEvent.CLICK, nav_top_menu_s5);
this.Btn_Right_Top.addEventListener(MouseEvent.CLICK, nav_top_menu_s5);

// event listeners lower menu
this.Btn_Left_Lower.addEventListener(MouseEvent.CLICK, nav_lower_menu_s5);
this.Btn_Right_Lower.addEventListener(MouseEvent.CLICK, nav_lower_menu_s5);

this.Btn_ML_Main.addEventListener(MouseEvent.CLICK, change_lower_menu_s5);
this.Btn_ML_Side.addEventListener(MouseEvent.CLICK, change_lower_menu_s5);
this.Btn_ML_Docs.addEventListener(MouseEvent.CLICK, change_lower_menu_s5);

// function to navigate top menu
function nav_top_menu_s5(e:MouseEvent):void{
...
function nav_lower_menu_s5(e:MouseEvent):void{
...
function change_top_menu_s5(e:MouseEvent):void{
...
function change_lower_menu_s5(e:MouseEvent):void{
