...
this.Btn_Inventory.addEventListener(MouseEvent.CLICK, change_top_menu_s3);
this.Btn_Mission_Log.addEventListener(MouseEvent.CLICK, change_top_menu_s3);
this.Btn_Settings.addEventListener(MouseEvent.CLICK, change_top_menu_s3);

this.Btn_Left_Top.addEventListener(MouseEvent.CLICK, nav_top_menu_s3);
this.Btn_Right_Top.addEventListener(MouseEvent.CLICK, nav_top_menu_s3);

// event listeners lower menu
this.Btn_Left_Lower.addEventListener(MouseEvent.CLICK, nav_lower_menu_s3);
this.Btn_Right_Lower.addEventListener(MouseEvent.CLICK, nav_lower_menu_s3);

this.Btn_Inventory_Weapons.addEventListener(MouseEvent.CLICK, change_lower_menu_s3);
this.Btn_Inventory_Consumables.addEventListener(MouseEvent.CLICK, change_lower_menu_s3);
this.Btn_Inventory_Junk.addEventListener(MouseEvent.CLICK, change_lower_menu_s3);

// function to navigate top menu
function nav_top_menu_s3(e:MouseEvent):void{
...
function nav_lower_menu_s3(e:MouseEvent):void{
	...
	if(lower_nav_button == Btn_Right_Lower){
		...
		//trace('on consumables');
	}
}

// function to change top menu using mouse
function change_top_menu_s3(e:MouseEvent):void{
...
function change_lower_menu_s3(e:MouseEvent):void{
